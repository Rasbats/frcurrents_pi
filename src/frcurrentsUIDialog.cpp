...
bool frcurrentsUIDialog::LoadStandardPorts()
{
    ...
    my_ports.clear();
			...
			wxString wxPORT_NUMBER,wxPORT_NAME,wxPORT_LAT, wxPORT_LON, PMVE, PMME, BMVE, BMME,IDX;			
...
void frcurrentsUIDialog::GetCurrents(wxString dirname, wxString filename) {
	...
	if (tidePort == "LES SABLES-D'OLONNE"){
...
vector<Position> frcurrentsUIDialog::OnRecord()
{	
return my_positions;
}

void frcurrentsUIDialog::SetFromHW(int fromHW) 
{
