...
frcurrentsUIDialogBase::frcurrentsUIDialogBase(wxWindow* parent, wxWindowID id,
  ...
  sbSizer71 = new wxStaticBoxSizer(
      new wxStaticBox(this, wxID_ANY, _("Tidal Area")), wxHORIZONTAL);

  wxString m_choiceAreaChoices[] = {_("Strait of Dover"),
                                    _("English Channel"),
  ...
  m_choiceArea =
      new wxChoice(sbSizer71->GetStaticBox(), wxID_ANY, wxDefaultPosition,
                   wxDefaultSize, m_choiceAreaNChoices, m_choiceAreaChoices, 0);
  ...
  m_button8 =
      new wxBitmapButton(sbSizer71->GetStaticBox(), wxID_ANY, wxNullBitmap,
  ...
  m_choice1 =
      new wxChoice(sbSizer6->GetStaticBox(), wxID_ANY, wxDefaultPosition,
                   wxDefaultSize, m_choice1Choices, 0);
  ...
  sbSizerDateTime = new wxStaticBoxSizer(
      new wxStaticBox(this, wxID_ANY, _("Tide Date")), wxHORIZONTAL);

  m_datePicker1 = new wxDatePickerCtrl(
      sbSizerDateTime->GetStaticBox(), wxID_ANY, wxDefaultDateTime,
  ...
  m_textCtrlCoefficient =
      new wxTextCtrl(sbSizerDateTime->GetStaticBox(), wxID_ANY, "   Coeff",
                     wxDefaultPosition, wxDefaultSize, wxTE_BESTWRAP);
  m_textCtrlCoefficient->SetFont(wxFont(10, wxFONTFAMILY_SWISS,
  ...
  m_staticTextHW = new wxStaticText(this, wxID_ANY, "High Water",
  ...
  sbSizerControls = new wxStaticBoxSizer(
      new wxStaticBox(this, wxID_ANY, _("Display Controls")), wxVERTICAL);

  wxFlexGridSizer* fbSizerCTRL = new wxFlexGridSizer(1, 6, 0, 0);
  fbSizerCTRL->AddGrowableCol(2);

  m_bpNow = new wxBitmapButton(sbSizerControls->GetStaticBox(), wxID_ANY,
  ...
  m_staticText2 = new wxStaticText(sbSizerControls->GetStaticBox(), wxID_FIND,
                                   "Display date/time", wxDefaultPosition,
                                   wxDefaultSize, 0);
  m_staticText2->Wrap(-1);
  fbSizerDT->Add(m_staticText2, 0, wxALIGN_CENTER_HORIZONTAL | wxALL, 5);

  m_staticText211 =
      new wxStaticText(sbSizerControls->GetStaticBox(), wxID_FIND,
                       "High Water +-", wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_bpPrev = new wxBitmapButton(sbSizerControls->GetStaticBox(), wxID_ANY,
                                wxNullBitmap, wxDefaultPosition, wxSize(-1, -1),
                                wxBU_AUTODRAW | 0);
  m_bpPrev->SetToolTip(_("Previous"));
  fbSizerCTRL->Add(m_bpPrev, 0, wxALIGN_CENTER | wxALL, 5);

  m_bpNext = new wxBitmapButton(sbSizerControls->GetStaticBox(), wxID_ANY,
                                wxNullBitmap, wxDefaultPosition, wxSize(-1, -1),
                                wxBU_AUTODRAW | 0);
  ...
  m_button4 = new wxButton(sbSizerControls->GetStaticBox(), 0, _("HW-6"),
                           wxDefaultPosition, wxDefaultSize, 0);
  bSizer4->Add(m_button4, 0, wxALL, 5);

  bSizer4->Add(0, 0, 1, wxEXPAND, 5);

  m_button5 = new wxButton(sbSizerControls->GetStaticBox(), 6, _("HW"),
                           wxDefaultPosition, wxDefaultSize, 0);
  bSizer4->Add(m_button5, 0, wxALL, 5);

  bSizer4->Add(0, 0, 1, wxEXPAND, 5);

  m_button6 = new wxButton(sbSizerControls->GetStaticBox(), 12, _("HW+6"),
                           wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_staticText1 = new wxStaticText(this, wxID_FIND, "Time Zone",
                                   wxDefaultPosition, wxDefaultSize, 0);
  ...
  this->Connect(wxEVT_CLOSE_WINDOW,
                wxCloseEventHandler(frcurrentsUIDialogBase::OnClose));
  this->Connect(wxEVT_LEFT_DCLICK,
                wxMouseEventHandler(frcurrentsUIDialogBase::OnDLeftClick));
  ...
  m_choiceArea->Connect(
      wxEVT_COMMAND_CHOICE_SELECTED,
      wxCommandEventHandler(frcurrentsUIDialogBase::OnAreaSelected), NULL,
      this);
  m_button8->Connect(
      wxEVT_COMMAND_BUTTON_CLICKED,
      wxCommandEventHandler(frcurrentsUIDialogBase::OnPreferences), NULL, this);
  m_choice1->Connect(
      wxEVT_COMMAND_CHOICE_SELECTED,
      wxCommandEventHandler(frcurrentsUIDialogBase::OnPortChanged), NULL, this);
  m_datePicker1->Connect(
      wxEVT_DATE_CHANGED,
      wxDateEventHandler(frcurrentsUIDialogBase::OnDateSelChanged), NULL, this);
  m_bpNow->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                   wxCommandEventHandler(frcurrentsUIDialogBase::OnNow), NULL,
                   this);
  m_bpPrev->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                    wxCommandEventHandler(frcurrentsUIDialogBase::OnPrev), NULL,
                    this);
  m_bpNext->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                    wxCommandEventHandler(frcurrentsUIDialogBase::OnNext), NULL,
                    this);
  m_button5->Connect(
      wxEVT_COMMAND_BUTTON_CLICKED,
      wxCommandEventHandler(frcurrentsUIDialogBase::OnChooseTideButton), NULL,
      this);
  m_button4->Connect(
      wxEVT_COMMAND_BUTTON_CLICKED,
      wxCommandEventHandler(frcurrentsUIDialogBase::OnChooseTideButton), NULL,
  ...
  this->Connect(
      wxEVT_CONTEXT_MENU,
      wxContextMenuEventHandler(frcurrentsUIDialogBase::OnContextMenu), NULL,
      this);
  this->Connect(
      wxEVT_COMMAND_MENU_SELECTED,
      wxCommandEventHandler(frcurrentsUIDialogBase::OnContextMenuSelect), NULL,
      this);
...
frcurrentsUIDialogBase::~frcurrentsUIDialogBase() {
  ...
  this->Disconnect(wxEVT_LEFT_DCLICK,
                   wxMouseEventHandler(frcurrentsUIDialogBase::OnDLeftClick));
  this->Disconnect(wxEVT_MOVE,
                   wxMoveEventHandler(frcurrentsUIDialogBase::OnMove));
  this->Disconnect(wxEVT_SIZE,
                   wxSizeEventHandler(frcurrentsUIDialogBase::OnSize));
  ...
  m_button8->Disconnect(
      wxEVT_COMMAND_BUTTON_CLICKED,
      wxCommandEventHandler(frcurrentsUIDialogBase::OnPreferences), NULL, this);
  m_choice1->Disconnect(
      wxEVT_COMMAND_CHOICE_SELECTED,
      wxCommandEventHandler(frcurrentsUIDialogBase::OnPortChanged), NULL, this);
  m_datePicker1->Disconnect(
      wxEVT_DATE_CHANGED,
      wxDateEventHandler(frcurrentsUIDialogBase::OnDateSelChanged), NULL, this);
  m_bpNow->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                      wxCommandEventHandler(frcurrentsUIDialogBase::OnNow),
                      NULL, this);
  m_bpPrev->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                       wxCommandEventHandler(frcurrentsUIDialogBase::OnPrev),
                       NULL, this);
  m_bpNext->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                       wxCommandEventHandler(frcurrentsUIDialogBase::OnNext),
                       NULL, this);
  m_button5->Disconnect(
      wxEVT_COMMAND_BUTTON_CLICKED,
      wxCommandEventHandler(frcurrentsUIDialogBase::OnChooseTideButton), NULL,
      this);
  m_button4->Disconnect(
      wxEVT_COMMAND_BUTTON_CLICKED,
      wxCommandEventHandler(frcurrentsUIDialogBase::OnChooseTideButton), NULL,
      this);
...
frcurrentsPreferencesDialogBase::frcurrentsPreferencesDialogBase(
  ...
  m_button01 = new wxButton(this, wxID_ANY, _("Information"), wxDefaultPosition,
                            wxDefaultSize, 0);
  ...
  sbSizer5 = new wxStaticBoxSizer(
      new wxStaticBox(this, wxID_ANY, _("Arrow Style")), wxVERTICAL);
  ...
  m_staticText8 =
      new wxStaticText(sbSizer5->GetStaticBox(), wxID_ANY, _("Options:   "),
                       wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_cStyle = new wxChoice(sbSizer5->GetStaticBox(), wxID_ANY, wxDefaultPosition,
  ...
  sbSizer11 = new wxStaticBoxSizer(
      new wxStaticBox(sbSizer5->GetStaticBox(), wxID_ANY, _("Arrow Options :")),
      wxVERTICAL);

  m_staticText13 = new wxStaticText(
      sbSizer11->GetStaticBox(), wxID_ANY,
      _("1: Normal\n2: Small \n3: Normal length, \n    narrow width"),
      wxDefaultPosition, wxDefaultSize, 0);
  ...
  sbSizerHarmonics = new wxStaticBoxSizer(
      new wxStaticBox(this, wxID_ANY, _("Tide Harmonics IDX Directory")),
      wxVERTICAL);

  m_button02 =
      new wxButton(sbSizerHarmonics->GetStaticBox(), wxID_ANY,
                   _("Select Directory"), wxDefaultPosition, wxDefaultSize, 0);
  sbSizerHarmonics->Add(m_button02, 0, wxALL, 5);

  m_dirPicker1 =
      new wxTextCtrl(sbSizerHarmonics->GetStaticBox(), wxID_ANY, wxEmptyString,
                     wxDefaultPosition, wxDefaultSize, 0);
  ...
  sbSizerTime =
      new wxStaticBoxSizer(new wxStaticBox(sbSizerScale->GetStaticBox(),
                                           wxID_ANY, _("Time Zone Options")),
                           wxVERTICAL);
  wxString m_choiceTimes[] = {_("UTC"), _("Local TZ")};
  int m_choiceNTimes = sizeof(m_choiceTimes) / sizeof(wxString);
  m_rTimeZoneOptions = new wxRadioBox(
      sbSizerTime->GetStaticBox(), wxID_ANY, _(""), wxDefaultPosition,
      wxDefaultSize, m_choiceNTimes, m_choiceTimes, 0, wxRA_SPECIFY_ROWS);
  m_rTimeZoneOptions->SetToolTip(
      _("'Local TZ' means Time Zone set on your device"));
  ...
  m_sIconSizeFactor->Connect(
      ...
      wxCommandEventHandler(
          frcurrentsPreferencesDialogBase::OnIconsSlidersChange),
      NULL, this);
  m_sFontSizeFactor->Connect(
      ...
      NULL, this);
  m_rTimeZoneOptions->Connect(
      wxEVT_RADIOBOX,
      wxCommandEventHandler(frcurrentsPreferencesDialogBase::OnTimeZoneChange),
      NULL, this);
  m_button01->Connect(
      wxEVT_COMMAND_BUTTON_CLICKED,
      wxCommandEventHandler(frcurrentsPreferencesDialogBase::OnShowInformation),
      NULL, this);
  m_button02->Connect(
      wxEVT_COMMAND_BUTTON_CLICKED,
      wxCommandEventHandler(frcurrentsPreferencesDialogBase::OnSelectData),
      NULL, this);
}
...
frcurrentsPreferencesDialogBase::~frcurrentsPreferencesDialogBase() {
  ...
  m_sFontSizeFactor->Disconnect(
      ...
      wxCommandEventHandler(
          frcurrentsPreferencesDialogBase::OnFontSlidersChange),
      NULL, this);
  m_rTimeZoneOptions->Disconnect(
      wxEVT_RADIOBOX,
      wxCommandEventHandler(frcurrentsPreferencesDialogBase::OnTimeZoneChange),
      NULL, this);
  m_button01->Disconnect(
      wxEVT_COMMAND_BUTTON_CLICKED,
      wxCommandEventHandler(frcurrentsPreferencesDialogBase::OnShowInformation),
      NULL, this);
  m_button02->Disconnect(
      wxEVT_COMMAND_BUTTON_CLICKED,
      wxCommandEventHandler(frcurrentsPreferencesDialogBase::OnSelectData),
      NULL, this);
}
