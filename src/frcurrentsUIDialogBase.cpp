...
frcurrentsUIDialogBase::frcurrentsUIDialogBase(wxWindow* parent, wxWindowID id,
  ...
  m_button7 =
      new wxButton(sbSizer61->GetStaticBox(), wxID_ANY, _("Select Directory"),
                   wxDefaultPosition, wxDefaultSize, 0);
  sbSizer61->Add(m_button7, 0, wxALL, 5);

  m_dirPicker1 =
      new wxTextCtrl(sbSizer61->GetStaticBox(), wxID_ANY, wxEmptyString,
                     wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_button7->Connect(
      wxEVT_COMMAND_BUTTON_CLICKED,
      wxCommandEventHandler(frcurrentsUIDialogBase::OnSelectData), NULL, this);
  this->Connect(
      wxEVT_CONTEXT_MENU,
