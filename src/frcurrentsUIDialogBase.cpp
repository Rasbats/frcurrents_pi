...
frcurrentsPreferencesDialogBase::frcurrentsPreferencesDialogBase(
  ...
  if (m_bcompact) {
    ...
    m_cbUseRate =
        new wxCheckBox(this, wxID_ANY, _("Display tidal rates (knots)"),
                       wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_cbUseHighRes =
        new wxCheckBox(this, wxID_ANY, _("High Resolution Display"),
                       wxDefaultPosition, wxDefaultSize, 0);
    ...
    staticTextLess05 = new wxStaticText(sbSizerColours->GetStaticBox(),
                                        wxID_ANY, _("      < 0.5 knots"),
                                        wxDefaultPosition, wxDefaultSize, 0);
    staticTextLess05->Wrap(-1);
    fgSizerColours->Add(staticTextLess05, 0, wxALIGN_CENTER_VERTICAL | wxALL,
                        5);
    ...
    sbSizer11 =
        new wxStaticBoxSizer(new wxStaticBox(sbSizer5->GetStaticBox(), wxID_ANY,
                                             _("Arrow Options :")),
                             wxVERTICAL);
    ...
    m_sIconSizeFactor =
        new wxSlider(sbSizerIconsFactor->GetStaticBox(), wxID_ANY, 0, -6, 6,
    ...
    m_sFontSizeFactor =
        new wxSlider(sbSizerFontFactor->GetStaticBox(), wxID_ANY, 0, -3, 3,
                     wxDefaultPosition, wxDefaultSize,
                     wxSL_BOTTOM | wxSL_HORIZONTAL | wxSL_LABELS);
