...
// #include "frcurrentsSettingsDialog.h"
// #include "frcurrentsReader.h"
// #include "frcurrentsRecordSet.h"
#include "tinyxml.h"
#include <list>
#include <vector>
...
public:
    ...
    wxArrayString PMVEew, PMVEns, PMMEew, PMMEns, BMVEew, BMVEns, BMMEew,
        BMMEns;
};
...
private:
    ...
    double PMVEew[13], PMVEns[13], PMMEew[13], PMMEns[13], BMVEew[13],
        BMVEns[13], BMMEew[13], BMMEns[13];
